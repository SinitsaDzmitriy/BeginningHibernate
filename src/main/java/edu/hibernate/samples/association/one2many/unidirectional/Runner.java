package edu.hibernate.samples.association.one2many.unidirectional;

import edu.hibernate.samples.evaluator.util.SessionUtil;
import edu.hibernate.samples.association.one2many.unidirectional.entities.Person;
import edu.hibernate.samples.association.one2many.unidirectional.entities.Phone;
